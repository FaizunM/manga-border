...
export const LabelView = ({
  ...
  return (
    <div className="h-[10] p-1 rounded-xl border-[1px] border-[rgba(255,255,255,0.05)] text-sm flex gap-1">
      <InputText
        name="label"
        id="label"
...
const Button = ({
  ...
  return (
    <div
      className="h-8 w-8 flex items-center justify-center hover:bg-[rgba(255,255,255,0.025)] rounded-xl text-sm"
      onClick={onClick}
    >
      {children}
    </div>
...
const SwitchButton = ({
  ...
  return (
    <div
      className={`px-3 h-8 flex items-center justify-center hover:bg-[rgba(255,255,255,0.025)] rounded-xl text-sm`}
      onClick={onClick}
    >
...
const InputText = ({
  ...
  return (
    <input
      ...
      className="h-8 w-[100px] rounded-xl bg-[rgba(255,255,255,0.02)] px-2 outline-none"
      onChange={onChange}
      value={value}
      id={id}
    />
