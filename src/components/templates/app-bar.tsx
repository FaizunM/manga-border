export const AppBar = ({ onBarClick }: { onBarClick: () => void }) => {
  return (
    <div className="w-full h-[64px] flex items-center gap-4 py-2">
      ...
      <div className="bg-[rgba(0,0,0,0.025)] hover:bg-[rgba(0,0,0,0.05)] transition-all duration-200 ease-in-out rounded-full p-2 pr-8 flex items-center gap-2">
...
const BarsButton = ({ onClick }: { onClick: () => void }) => {
  return (
    <div
      ...
      onClick={onClick}
    >
      <div className="w-6 group-hover:w-6 transition-all duration-200 ease-in-out h-[2px] bg-black"></div>
      <div className="w-4 group-hover:w-6 transition-all duration-200 ease-in-out h-[2px] bg-black"></div>
      <div className="w-5 group-hover:w-6 transition-all duration-200 ease-in-out h-[2px] bg-black"></div>
    </div>
  );
};
